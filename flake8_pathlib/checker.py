...
call_errors = {
    "os.path.abspath": partial_error(id="PL100", message="os.path.abspath found"),
    "os.chmod": partial_error(id="PL101", message="os.chmod found"),
    "os.mkdir": partial_error(id="PL102", message="os.mkdir found"),
    "os.makedirs": partial_error(id="PL103", message="os.makedirs found"),
    "os.rename": partial_error(id="PL104", message="os.rename found"),
    "os.replace": partial_error(id="PL105", message="os.replace found"),
    "os.rmdir": partial_error(id="PL106", message="os.rmdir found"),
    "os.remove": partial_error(id="PL107", message="os.remove found"),
    "os.unlink": partial_error(id="PL108", message="os.unlink found"),
    "os.getcwd": partial_error(id="PL109", message="os.getcwd found"),
    "os.path.exists": partial_error(id="PL110", message="os.path.exists found"),
    "os.path.expanduser": partial_error(id="PL111", message="os.path.expanduser found"),
    "os.path.isdir": partial_error(id="PL112", message="os.path.isdir found"),
    "os.path.isfile": partial_error(id="PL113", message="os.path.isfile found"),
    "os.path.islink": partial_error(id="PL114", message="os.path.islink found"),
    "os.readlink": partial_error(id="PL115", message="os.readlink found"),
    "os.stat": partial_error(id="PL116", message="os.stat found"),
    "os.path.isabs": partial_error(id="PL117", message="os.path.isabs found"),
    "os.path.join": partial_error(id="PL118", message="os.path.join found"),
    "os.path.basename": partial_error(id="PL119", message="os.path.basename found"),
    "os.path.dirname": partial_error(id="PL120", message="os.path.dirname found"),
    "os.path.samefile": partial_error(id="PL121", message="os.path.samefile found"),
    "os.path.splitext": partial_error(id="PL122", message="os.path.splitext found"),
    "open": partial_error(
        id="PL123",
